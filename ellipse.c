/**
 * PiPilot ellipse loop
 *
 * @return void
 */
void pipilot_run_ellipse() {
	print_to_screen( "ellipse", "initializing", 0 );

	int loop_i = 1;

	while ( MODE_ELLIPSE == get_master_mode() ) {
		print_to_screen( "ellipse", "loop iteration", loop_i );
